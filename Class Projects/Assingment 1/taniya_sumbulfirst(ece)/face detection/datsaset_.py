import cv2, os, time
# change the paths below to the location where these files are on your machinehaar_file = "haarcascade_frontalface_default.xml"
# # All of the faces data (images) will be stored here
# dataset = "C:/Users/taniy/PycharmProjects/skill sprint 2.0/dataset"

...
#img= cv2.imread("WhatsApp Image 2024-01-16 at 17.19.11_c0d5018b.jpg")
...
while True:
    ...
    cv2.putText(frame, 'AYUSH SINGH', (200, 470), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 200), 2)
    frame=cv2.putText(frame,date_time,(10,60),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,200),3,cv2.LINE_AA)
